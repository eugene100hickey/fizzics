...
A reminder, this is the map of bedrock data we had from part I.
...
From part II, we recruited three sets of satelllite images from Sentinel; one from June, one end-August, and the last from December 2022. Our next task is to stack these together into a raster stack object.
...
s2_plot <- plotRGB(s2, r = 4, g= 8, b = 12, stretch = "hist")
```
