...
ref |> 
  ...
  slice_sample(n=10) |> 
  gt::gt() |> 
    gt::opt_table_font(google_font("Libre Baskerville"), 
                 # Roboto Condensed - Syne Tactile - Quintessential - Architects Daughter
                 weight = 200)
```

```{r bedock-map, out.width="150%"}
my_extent <- c(xmin=540000, xmax=565000, ymin=6050000, ymax=6090000)
my_extent <- c(xmin=510000, xmax=570000, ymin=6030000, ymax=6150000)
