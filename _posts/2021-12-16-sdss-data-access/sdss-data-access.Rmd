...
The spectrum from sdss is shown below, and can be seen [here](http://cas.sdss.org/dr17/VisualTools/explore/summary?objId=1237650795146576079)
...
Note, for some reason the SDSS objid returned from the SSQL query is incorrect. I'm still trying to figure out why and to fix this.
