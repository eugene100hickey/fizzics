...
description: |
  Horn Head gets the _Rayshader_ Treatment.
author:
  - name: Eugene
...
```{r sentinel-results}
knitr::kable(query %>% dplyr::select(-c(record_id)))
```
...
plotRGB(horn_head_10m_crop, r = 3, g = 2, b = 1, stretch = "hist")
```

Giving:

![](img/horn-head-2021.png)
...
knitr::include_graphics('img/three-D-model.png')
```
