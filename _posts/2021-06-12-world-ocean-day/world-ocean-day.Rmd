...
knitr::include_graphics('images/sheephaven.jpeg')
```
...
And now, let's draw our map, colouring the points by the year of observation. Seeing as we're talkin about the ocean here, I thought a bathyscape map would be best, hence the `addProviderTiles(providers$Esri.OceanBasemap)` line.
...
species_observations %>% 
  ...
  addCircles(lng = ~ decimalLatitude,
...
See if you can find the two whales, one off Malin and the second off Belmullet.
