...
At the moment, shinyapps.io is having trouble working with `arcgisgeocoder`, otherwise I'd link to a web version of this app. I'll work on this. For the moment, here is  aversion based on `tidygeocoder` that doesn't quite work as well.
