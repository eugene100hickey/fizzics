...
Next question is, which ones feature _Environmental Science_? To find out, we went to the [CAO website](www2.cao.ie). There you can track down and access a bunch of pdf's and excel spreadsheets that detail the various courses, as well as the points required for entry. And it gives this information going back several years. A data treasure trove.
