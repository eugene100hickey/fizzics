...
irish_universities <- readRDS("irish-universities.rds")
cohort_universities <- readRDS("cohort-universities.rds")

SDG7_Energy <- readRDS("SDG7-energy-scoring-breakdown.rds")

SDG7_Energy_metrics <- readRDS(file = "SDG7-Energy-metrics.rds")

overs <- readRDS("overs.rds")

z1 <- readRDS("SDG7-shuffled-data.rds")
